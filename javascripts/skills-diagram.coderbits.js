...
var CBSkillsDiagram = function( options, callback ) {
  ...
  this.username  = container.data('coderbits-username');
  this.subject   = container.data('coderbits-subject') || 'skills';
...
$(function() {
  $('.skills-diagram[data-coderbits-username]').each(function() {
